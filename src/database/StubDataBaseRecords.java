...
public class StubDataBaseRecords {
	...
	public void reset() {
		...
		servers = new ArrayList<Server>(Arrays.asList(new Server("1", "robert", "downey"),
				new Server("2", "peter", "parker"), new Server("3", "chris", "evans")));

		feedbacks = new ArrayList<Feedback>(
				Arrays.asList(new Feedback("1", "John doe", 4, LocalDateTime.now(), "excellent"),
						new Feedback("2", "Jane doe", 3, LocalDateTime.now(), "terrible"),
						new Feedback("3", "Max Payne", 5, LocalDateTime.now(), "the best")));
		...
		reservations = new ArrayList<>(Arrays.asList(new Reservation("temp", "john", LocalDate.now(),
